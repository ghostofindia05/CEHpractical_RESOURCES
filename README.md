# CEHpractical_RESOURCES
These are the Resources for CEH Practical exam

# if u are interested u can also do the below free boxes not compulsory.
...
```
If any of these rooms are not working mail me:bollakrishna05@gmail.comm
Then i will change list
